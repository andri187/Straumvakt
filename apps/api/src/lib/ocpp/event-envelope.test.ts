// Ported from src/lib/ocpp/event-envelope.test.ts. Tests the validator
// for the gateway → API ingest envelope; unchanged from the UI-Worker
// version because the envelope shape doesn't change in the move.
