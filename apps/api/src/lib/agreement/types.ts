...
// packages/commercial/src/agreement/types.ts; this file exists so persist.ts,
...
// "@straumvakt/commercial/agreement/types" directly — not before.
//
...
export * from "@straumvakt/commercial/agreement/types";
export type * from "@straumvakt/commercial/agreement/types";
