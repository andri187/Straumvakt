...
// should import "@straumvakt/contracts/inputs/installations" directly; old ones move
// under touch-it-convert-it (FOCUS.md rule 1).
//
// Nothing was deleted. When the last caller points at contracts, this file
// goes — and not before.
export * from "@straumvakt/contracts/inputs/installations";
export type * from "@straumvakt/contracts/inputs/installations";
