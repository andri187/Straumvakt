...
// should import "@straumvakt/contracts/domain/vendor-user-groups" directly; old ones move
// under touch-it-convert-it (FOCUS.md rule 1).
//
// Nothing was deleted. When the last caller points at contracts, this file
// goes — and not before.
export * from "@straumvakt/contracts/domain/vendor-user-groups";
export type * from "@straumvakt/contracts/domain/vendor-user-groups";
