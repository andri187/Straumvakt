...
// should import "@straumvakt/contracts/domain/users" directly; old ones move
// under touch-it-convert-it (FOCUS.md rule 1).
//
// Nothing was deleted. When the last caller points at contracts, this file
// goes — and not before.
export * from "@straumvakt/contracts/domain/users";
export type * from "@straumvakt/contracts/domain/users";
