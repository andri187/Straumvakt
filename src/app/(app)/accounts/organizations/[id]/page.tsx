    ...
    <>
      <div className="mb-4 rounded-lg border border-bg-border bg-bg-base/30 p-4">
        ...
        <div className="grid gap-x-6 gap-y-2 text-sm sm:grid-cols-2">
          <Row
            label="Kennitala"
            value={org.kennitala ? formatKennitala(org.kennitala) : null}
            mono
          />
          ...
          <Row
            label="Legal form"
            value={
              [org.legalForm, org.legalFormCode ? `[${org.legalFormCode}]` : null]
                .filter(Boolean)
                .join(" ") || null
            }
          />
          ...
          <Row
            label="Sveitarfélag"
            value={
              [org.municipalityCode, org.municipalityName]
                .filter(Boolean)
                .join(" ") || null
            }
          />
